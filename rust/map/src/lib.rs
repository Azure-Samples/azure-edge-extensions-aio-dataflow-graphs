...
mod map_custom {
    ...
    fn decode_and_rescale_init(configuration: ModuleConfiguration) -> bool {
        ...
        // Convert SDK config to custom WIT config
    ...
    fn decode_and_rescale(input: DataModel) -> Result<DataModel, Error> {
        ...
        // Extract payload from SDK DataModel and preserve message structure
        ...
        // Convert to custom WIT DataModel
        let custom_input = crate::custom_wit::DataModel { payload };

        // Call the imported custom function
        ...
        // Convert back to SDK DataModel as Message
